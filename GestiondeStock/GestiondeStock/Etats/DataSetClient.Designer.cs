...
namespace GestiondeStock.Etats.DataSetClientTableAdapters {
    ...
    public partial class ClientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Client] WHERE (([Id_Client] = @Original_Id_Client) AND ([Nom_Client]" +
                " = @Original_Nom_Client) AND ([Contact_Client] = @Original_Contact_Client) AND (" +
                "[Localisation_Client] = @Original_Localisation_Client))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Client] ([Nom_Client], [Contact_Client], [Localisation_Client]) VALU" +
                "ES (@Nom_Client, @Contact_Client, @Localisation_Client);\r\nSELECT Id_Client, Nom_" +
                "Client, Contact_Client, Localisation_Client FROM Client WHERE (Id_Client = SCOPE" +
                "_IDENTITY())";
...
SELECT Id_Client, Nom_Client, Contact_Client, Localisation_Client FROM Client WHERE (Id_Client = @Id_Client)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id_Client, Nom_Client, Contact_Client, Localisation_Client\r\nFROM   Client";
